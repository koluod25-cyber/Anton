...
## Perbaikan laporan dan printer

Neraca sekarang memakai transaksi kumulatif sampai tanggal akhir laporan. Transaksi sebelum tanggal awal filter tetap dibawa sebagai saldo awal, sehingga memilih periode laporan tidak lagi menghilangkan saldo kas, piutang, modal, atau pajak yang sudah terbentuk sebelumnya. Service worker juga memakai versi cache baru dan menghapus cache versi lama ketika aplikasi diperbarui.

Pengaturan printer menyediakan pencarian **Web Bluetooth BLE** melalui Chrome Android pada HTTPS. Banyak printer thermal kasir menggunakan Bluetooth Classic/SPP, yang tidak dapat diakses oleh Web Bluetooth; printer jenis tersebut tetap memerlukan bridge/native Android atau printer Wi-Fi. Tombol **Cetak** masih menggunakan Android/Chrome Print untuk fallback umum.
